...
const tip = "A text message width a 4-digit virification code was just sent to xxx xxx xx78";
    ...
    <View style={styles.container}>
        ...
        >
            ...
            <View style={styles.input}>
                <Input icon={require("../../assets/image/icons_png/mobile-icon.png")} placeholder="Mobile number" password />
